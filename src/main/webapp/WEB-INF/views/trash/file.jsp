				...
				<form action="subReview">
				  ...
				  <c:if test = "${not empty list}">
				   <c:forEach items = "${list}" var = "review" varStatus = "status">
				   	<!-- <input type = "hidden" id = "beforereviewreplygroupid${status.index}" value = "${review.bgroup}"> -->
					<li>
						<div class="comment_wrap">
							<dl>
								...
								<dd class="btns">
									<span> 
										<!-- <img src="${pageContext.request.contextPath}/resources/img/review/ico_bought2.gif" alt="구매"> --> 
							...
							<div class="cmt_rt">
								<ul class="list_share">
									<li class="cmt_reply"><a href = "#" style = "cursor:pointer">댓글</a></li>
									<c:if test= "${sessionScope.Userid eq review.user_id}">
										<li  class="cmt_del2"><a style = "cursor:pointer" href="#" onclick = "reviewdelete(${review.rid})">삭제</a></li>
									</c:if>
									<c:if test= "${sessionScope.Userid eq review.user_id}">
